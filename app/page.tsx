...
import { RepeatPicker, type RRuleOutput } from "@/components/repeat-picker";
import {
  parseRRuleString,
  type SimplifiedRRuleConfig,
} from "@/lib/rrule-config";

export default function Home() {
  const [output, setOutput] = useState<RRuleOutput | null>(null);
  const [storedConfig, setStoredConfig] =
    useState<SimplifiedRRuleConfig | null>(null);
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Create a custom recurrence schedule for your quiz
          </p>
